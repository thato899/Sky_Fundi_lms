...
<div class="wrap" style="max-width:680px;padding:3rem 0">
 <div class="eyebrow">Learner portal invitation</div>
 <h1>{{ $organization->name }} invited you</h1>
 <p>Accept this invitation to access the school’s restricted learner portal. Learner details appear only after acceptance and only when the school has explicitly linked them to your learner profile.</p>
 ...
 <form method="POST" action="{{ route('learner-invitations.accept',$token) }}" style="display:grid;gap:1rem">
  @csrf
