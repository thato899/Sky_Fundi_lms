...
- Organization API coverage remains substantially thinner than its README inventory: lifecycle, settings, administrator/module assignment, encrypted AI configuration, validation, and policy denial are not directly represented in the current module test file.
...
- Organization lifecycle/configuration APIs need a dedicated focused suite.
