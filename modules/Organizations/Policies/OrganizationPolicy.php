...
final class OrganizationPolicy
{
    ...
    {
        return $user->can('organizations.view') || $organization->administrators()->whereKey($user->id)->exists();
    }

    public function update(User $user, Organization $organization): bool
    {
        return $user->can('organizations.manage') || $organization->administrators()->whereKey($user->id)->exists();
    }
