...
final class AssessmentsPermissionSeeder extends Seeder
{
    ...
    public function run(RoleService $roles): void
    {
        ...
        foreach (['Teacher', 'Tutor'] as $name) {
            $this->grant($name, ['assessments.view', 'assessments.create', 'assessments.update', 'assessments.mark', 'assessments.finalize', 'assessments.export', 'quizzes.view', 'quizzes.create', 'quizzes.update', 'quizzes.publish', 'quizzes.assign', 'quizzes.ai_draft', 'quiz_submissions.view', 'quiz_submissions.mark', 'quiz_submissions.release', 'study_plans.generate', 'study_plans.approve', 'study_plans.analytics', 'interventions.view', 'interventions.manage']);
        }
