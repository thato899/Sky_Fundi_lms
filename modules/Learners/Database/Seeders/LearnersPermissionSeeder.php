...
final class LearnersPermissionSeeder extends Seeder
{
    private const PERMISSIONS = [
        ...
        'learners.invite' => 'Send and manage learner portal invitations',
        'learners.view_enrolment_history' => 'View immutable learner academic enrolment history',
        'learners.correct_enrolment' => 'Correct historical enrolment records',
    ...
    private const ADMIN_PERMISSIONS = [
        ...
        'learners.invite', 'learners.view_enrolment_history', 'learners.correct_enrolment',
