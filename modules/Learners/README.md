...
Learner login accounts, invitations, portal workflows, guardians, imports, documents, consent, homework, report cards, historical enrolments, RAG/AI features, and mobile functionality are explicitly not implemented here. The separate Attendance and Assessments modules read trusted current placement and expose administrative histories without modifying learner records; assessment history accuracy is limited by the absence of historical enrolment.
