...
final class HackathonDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::transaction(function () use ($password): void {
            $organization = Organization::query()->updateOrCreate(['code' => 'UFA-DEMO'], ['name' => 'Demo School', 'type' => 'school', 'status' => 'active', 'email' => 'admin@ubuntu-future.demo', 'country' => 'ZA', 'currency' => 'ZAR', 'maximum_users' => 50]);
            ...
            $tutor = $this->user('tutor@ubuntu-future.demo', 'Kabelo Tutor', $password);
            ...
            $tutorMembership = $this->membership($organization, $tutor, 'Tutor');
