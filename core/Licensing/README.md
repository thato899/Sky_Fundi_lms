...
**Responsibilities**:
- `Infrastructure/Models/License` — `licensee_type`/`licensee_id` are a nullable polymorphic pair; a null licensee means a platform-wide license. Entitlements include user, learner, and storage limits. Modules consume these values without introducing reverse Core-to-module dependencies.
