...
final class Membership extends Model
{
    ...
    {
        return ['status' => MembershipStatus::class, 'joined_at' => 'datetime', 'accepted_at' => 'datetime', 'last_active_at' => 'datetime', 'invitation_expires_at' => 'datetime', 'is_primary' => 'boolean', 'is_default' => 'boolean'];
    }
